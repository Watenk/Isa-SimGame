...
public class Tile
{
    ...
    public Tile(ID groundID, int oxygenAmount, int carbonDioxideAmount, Vector2Int pos, int temp, int thermalConductivity, int lightLevel, int humidity, int fertility)
    {
